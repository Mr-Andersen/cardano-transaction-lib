...
export const verifySignature =
  coseSign1 => publicKey => sigStructBytes => () => {
...
export const getSignedData = coseSign1 => () => {
...
export const _getCoseSign1ProtectedHeaderAlg = maybe => coseSign1 => {
...
export const _getCoseSign1ProtectedHeaderAddress = maybe => coseSign1 => {
  const protectedHeaders = getCoseSign1ProtectedHeaders(coseSign1);
...
export const _getCoseSign1ProtectedHeaderKid = maybe => coseSign1 => {
  const protectedHeaders = getCoseSign1ProtectedHeaders(coseSign1);
...
export const _getCoseKeyHeaderX = maybe => coseKey => {
  const cborValue = coseKey.header(
    lib.Label.new_int(
...
export const _getCoseKeyHeaderKid = maybe => coseKey => {
