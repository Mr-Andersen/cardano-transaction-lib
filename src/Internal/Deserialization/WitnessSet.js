...
export const extractWitnesses = containerExtractor;
...
export const extractNativeScripts = containerExtractor;
export const nativeScriptAs = maybe => prop => res => ns =>
  ns[prop]() == null ? maybe.nothing : maybe.just(res);
export const getBootstraps = callMaybe("bootstraps");
export const extractBootstraps = containerExtractor;
...
export const extractPlutusScripts = containerExtractor;
...
export const extractPlutusData = containerExtractor;
...
export const extractRedeemers = containerExtractor;
