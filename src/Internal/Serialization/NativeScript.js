...
export const mkScriptPubkey = keyHash => lib.ScriptPubkey.new(keyHash);
...
export const _packNativeScripts = helper => nss =>
  helper.pack(lib.NativeScripts, nss);
export const mkScriptAll = nss => lib.ScriptAll.new(nss);
export const mkScriptAny = nss => lib.ScriptAny.new(nss);
export const mkScriptNOfK = n => nss => lib.ScriptNOfK.new(n, nss);
export const mkTimelockExpiry = n => lib.TimelockExpiry.new_timelockexpiry(n);
export const mkTimelockStart = n => lib.TimelockStart.new_timelockstart(n);
